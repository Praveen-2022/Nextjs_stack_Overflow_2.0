# Next.js 14 DevGuru's Hub

<!-- GitHub badges -->

[![GitHub commits](https://img.shields.io/github/commit-activity/t/Praveen-2022/Nextjs_stack_Overflow_2.0?style=social&logo=github)](https://github.com/Praveen-2022/Nextjs_stack_Overflow_2.0/commits)


[![Top Language](https://img.shields.io/github/languages/top/Praveen-2022/Nextjs_stack_Overflow_2.0?logo=github&logoColor=%23007ACC&label=TypeScript)](https://www.typescriptlang.org/)
...
<details><summary><b>Dev Guru's Hub</b> is built using the following technologies:</summary>
...
```bash
git clone https://github.com/Praveen-2022/Nextjs_stack_Overflow_2.0.git
```
...
**DevGuru'sHub** uses [Clerk](https://clerk.com), [TinyMCE](https://uploadthing.com/), [RapidAPI](https://rapidapi.com), [OpenAI API](https://openai.com/blog/openai-api) and [MongoDB](https://mongodb.com) as external services. You need to create an account on each of these services and get the required credentials to run the app.
...
[![contributors](https://contrib.rocks/image?repo=Praveen-2022/Nextjs_stack_Overflow_2.0)](https://github.com/Praveen-2022/Nextjs_stack_Overflow_2.0/graphs/contributors)
...
If you find a bug (failure of a module to execute its intended function), kindly open an issue [here](https://github.com/Praveen-2022/Nextjs_stack_Overflow_2.0/issues/new) by including the issue with a title and clear description.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/Praveen-2022/Nextjs_stack_Overflow_2.0/issues/new). Please include sample queries and their corresponding results.
